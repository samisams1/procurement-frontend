...
import RFQDraftComponent from '../../components/pageComponents/Quotation/rfqDraft';
...
const RfqDraft: React.FC = () => {
  ...
  if (role === 'SUPPLIER') {
    if (data && data.supplierIdByUserId) {
      const supplierId = data.supplierIdByUserId.id;
      return <RFQDraftComponent  supplierId= {supplierId}/>;;
    }
  } else {
    return null;
  }

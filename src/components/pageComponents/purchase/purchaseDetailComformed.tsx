...
const purchaseDetailComformed: React.FC<{ id: number | null, status:string,customerId:string,supplierId:number }> = ({ id,status,customerId,supplierId }) => {
...
export default purchaseDetailComformed;